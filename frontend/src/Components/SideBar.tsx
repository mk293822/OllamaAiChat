...
const SideBar = () => {
  return (
    <aside className="flex flex-col w-52 py-3 h-screen">
      <header className="flex items-center justify-between text-gray-200 h-[4%] px-3">
        <h3 className="font-bold text-lg">Gemma3</h3>
        <span className="font-bold text-xl cursor-pointer">
          <Sidebar className="w-5 h-5" />
        </span>
      </header>
      <section className="flex flex-col border-t border-gray-600 w-full px-3 pt-3 flex-1 my-4 space-y-2 overflow-y-auto scrollable h-[95%]">
